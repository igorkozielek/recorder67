...
- [x] **Wgrywanie Gotowych Plików Audio/Wideo (MP4, MKV, WAV, MP3, M4A, FLAC)**: Wgrywanie zewnętrznych nagrań ze spotkań, automatyczna ekstrakcja/normalizacja do 16kHz WAV bez systemowego FFmpeg, asynchroniczna transkrypcja z live-progression.
- [x] **Panel Mapowania i Weryfikacji Mówców (Speaker Mapping & Correction)**: Automatyczna autosugestia imion z kontekstu rozmowy, podgląd próbek wypowiedzi per mówca, możliwość szybkiej korekty w GUI oraz natychmiastowa podmiana etykiet w całym dokumencie i pliku `.txt`.
